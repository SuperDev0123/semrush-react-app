...
export const OPEN_SET_UP_MODAL = 'OPEN_SET_UP_MODAL'
export const CLOSE_SET_UP_MODAL = 'COSE_SET_UP_MODAL'

export const INIT_POLL_LIST = 'INIT_POLL_LIST'
export const GET_POLL_LIST_PENDING = 'GET_POLL_LIST_PENDING'
export const GET_POLL_LIST_SUCCESS = 'GET_POLL_LIST_SUCCESS'
export const GET_POLL_LIST_ERROR = 'GET_POLL_LIST_ERROR'
