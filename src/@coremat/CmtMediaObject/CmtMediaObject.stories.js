...
export const Default = () => (
  <CmtMediaObject
    avatar={image}
    avatarPos={select('Avatar Position', ['top', 'center', 'bottom'], 'top')}
    avatarProps={{
      style: { width: 60, height: 60 },
    }}
    title={text('Title', 'John Doe')}
    subTitle={text('Sub Title', 'Media Sub heading')}
    actionsComponent={<Typography component="span">3 hour ago</Typography>}
    content={text(
      'Content',
...
export const WithActions = () => (
  <CmtMediaObject
    ...
    avatarPos={select('Avatar Position', ['top', 'center', 'bottom'], 'top')}
    title={text('Title', 'John Doe')}
    subTitle={text('Sub Title', 'Posted on February 19, 2016')}
    actionsComponent={
      <React.Fragment>
        <Typography component="span">3 hour ago</Typography>
