...
export const WithColorBackground = () => (
  <CmtDrawer
    backgroundColor={['red']}
    variant={select(
      'Variant',
...
// colors, direction, image
// colors, opacity, direction
...
export const WithOverlay = () => (
  <CmtDrawer
    ...
    overlay={{
      colors: color('Overlay Color', '#000'),
      opacity: number('Overlay Opacity', 0.3),
    }}
    variant={select(
      'Variant',
      ['permanent', 'persistent', 'temporary'],
...
export const WithBackgroundAndGradientOverlay = () => (
  <CmtDrawer
    backgroundColor={'red'}
    overlay={{
      colors: array('Overlay Colors', ['red', 'yellow', 'green']),
      opacity: number('Overlay Opacity', 0.3),
      direction: text('Gradient Direction', 'to bottom'),
    }}
    variant={select(
      'Variant',
      ['permanent', 'persistent', 'temporary'],
