...
const NavMegaColumn = (props) => {
  ...
  const MenuCollapse = (
    <ListItem
      component="div"
      disableGutters
      className={clsx(classes.navMegaColumnInner, 'Cmt-navMegaColumnInner')}
    >
      {name && (
  ...
  return (
    <Box className={clsx(classes.navMegaColumn, 'Cmt-navMega-column')}>
      {MenuCollapse}
    </Box>
  )
}
  ...
  const MenuCollapse = (
    ...
    >
      <Box component="span" className={classes.navMegaBtnInner}>
        ...
        {totalItems > 0 && !open && (
          <ArrowDropDownIcon className={classes.navArrow} />
        )}
        {totalItems > 0 && open && (
          <ArrowDropUpIcon className={classes.navArrow} />
        )}
