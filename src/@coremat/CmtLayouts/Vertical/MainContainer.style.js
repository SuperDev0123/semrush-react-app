...
const useStyles = makeStyles((theme) => ({
  appRoot: (props) => ({
    ...
    '&.Cmt-fixedHeaderLayout.Cmt-sidebarCollapsed.verticalPagedLayout .Cmt-sidebar':
      {
        width: 90,
        ...
        '& .Cmt-nav-text,& .filterRoot': {
          display: 'none',
        },
      },
    '&.Cmt-fixedHeaderLayout.Cmt-sidebarCollapsed.verticalPagedLayout': {
      // "& .Cmt-header": {
      //     left: 90,
      //     width: `calc(100% - 90px)`,
      // },
    ...
    '&.Cmt-fixedHeaderLayout': {
      ...
      '& .Cmt-header': {
        ...
        zIndex: 1000,
        boxShadow: '0px -6px 16px 0px rgba(0,0,0,0.75)',
    ...
    '&.Cmt-miniLayout.Cmt-fixedHeaderLayout': {
      ...
      // '&.filterSidebar $appMain':{
      //   marginLeft:`calc(${props.miniSidebarWidth}px + 215px )`,
  ...
  appMain: (props) => {
    ...
    const isPollCreation = path.includes('poll-creation')
    return {
      display: 'flex',
      flexDirection: 'column',
      height: '100%',
      width: isPollCreation ? '100%' : `calc(100% - ${props.sidebarWidth}px)`,
      boxSizing: 'border-box',
      transition: 'all 0.3s ease',
      '.Cmt-sidebar-fixed &': {
        marginLeft: isPollCreation ? 0 : props.sidebarWidth / 2,
      },
      '.Cmt-miniLayout &': {
        width: isPollCreation
          ? '100%'
          : `calc(100% - ${props.miniSidebarWidth}px)`,
      ...
      '.Cmt-miniLayout.Cmt-sidebar-fixed &': {
        marginLeft: isPollCreation ? 0 : props.miniSidebarWidth / 2,
      },
      '.Cmt-drawerLayout &': {
        width: '100%',
        '& .Cmt-toggle-menu': {
      ...
      '.Cmt-modernLayout &': {
        width: `calc(100% - ${
          props.sidebarWidth + props.actionSidebarWidth
        }px)`,
      },
