      ...
      >
        ...
        <Box display="flex" alignItems="center" ml="auto">
          <Chip
            ...
            style={{
              backgroundColor:
                selectedProperty.availability === 'sale'
                  ? '#FF8C00'
                  : '#8DCD03',
            }}
            label={
              selectedProperty.availability === 'sale' ? 'For Sale' : 'For Rent'
            }
          />
        </Box>
      </Box>
          ...
          <Box>
            ...
            >
              <Box
                ...
                mr={4}
              >
                <PermIdentityIcon className={classes.iconRoot} />{' '}
                {selectedProperty.owner.name}
              </Box>
              <Box display="flex" flexDirection="row" alignItems="center">
                <ScheduleIcon className={classes.iconRoot} />{' '}
                {timeFromNow(selectedProperty.publishedDate)}
              </Box>
            </Box>
